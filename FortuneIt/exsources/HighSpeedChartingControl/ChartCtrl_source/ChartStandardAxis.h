...
public:
	...
	**/
	...
	double GetMinTickIncrement() const { return m_dMinTickIncrement; }
	void SetMinTickIncrement(double val) { m_dMinTickIncrement = val; }
private:
	//! Default constructor
	CChartStandardAxis();
	//! Default destructor
	...
	//! The minimum space between ticks (in axis value).
	double m_dMinTickIncrement;
};
