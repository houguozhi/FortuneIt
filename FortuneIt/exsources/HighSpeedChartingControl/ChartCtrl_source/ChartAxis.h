...
public:
   ...
   virtual double ScreenToValue(long ScreenVal) const;
	...
	double GetTickLabelOrientationInDegree() const { return m_dTickLabelOrientationInDegree; }
	double SetTickLabelOrientationInDegree(double val) { double old = m_dTickLabelOrientationInDegree; m_dTickLabelOrientationInDegree = val; return old; }
	bool GetEnableGrid() const { return m_bEnableGrid; }
	void SetEnableGrid(bool val) { m_bEnableGrid = val; }
public: // protected:
...
//	bool m_bIsAutomatic;  
	...
	**/
	...
	double m_dTickLabelOrientationInDegree;
	bool m_bEnableGrid;
